...
| To manage the access of a file, you must have navigated to the desired file. Refer `here </users/drive/guides/managing_a_file.html>`_ if you are having trouble reaching this point.

#. Click **Manage Access** in the info tab
