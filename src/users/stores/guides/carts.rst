...
| Once the `cart life </users/store/guides/create_a_store.html>`_ of a cart has expired, a previously **Active** cart will be considered **Abandoned**. Carts are sorted into these two categories of active and abandoned.
