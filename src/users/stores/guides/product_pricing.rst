...
| To price the products of a store, you will need to create a new product or edit the variant(s) of an already existing product. Refer to `Adding a Product to a Store </users/stores/guides/products.html>`_ if you are having trouble reaching this point.
