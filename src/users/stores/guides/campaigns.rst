...
#. Click :icon:`envelope` `Email </users/campaigns/guides/email/email_campaigns.html>`_ , :icon:`comment` `SMS </users/campaigns/guides/outbound_sms_campaigns/email_campaigns.html>`_ , or :icon:`phone` `Voice </users/campaigns/guides/voice/voice_campaigns.html>`_ to view the associated campaigns created for the store
#. Click :icon:`plus` to create a new campaign (`email </users/campaigns/guides/email/new_email_campaign.html>`_ , `SMS </users/campaigns/guides/email/new_outbound_sms_campaign.html>`_ , or `voice </users/campaigns/guides/email/new_voice_campaign.html>`_ )
