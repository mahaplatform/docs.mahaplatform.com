...
#. Click on an email
#. Click **Design Email**
#. You can add a new `block </users/automation/guides/emails/email_design_blocks.html>`_ to your email by clicking and dragging the desired block under **Blocks** to the desired place in the email
