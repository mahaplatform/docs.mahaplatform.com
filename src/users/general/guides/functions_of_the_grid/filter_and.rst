...
.. note::
   ...
   You should have navigated to the filter pop-up menu with conditional options. Refer to `filter guide </users/general/guides/how_to_filter_records.html>`_ if you are having trouble navigating to this page.
...
#. If available, select a `criteria option </users/general/guides/criteria_option.html>`_ (eg. equals)
