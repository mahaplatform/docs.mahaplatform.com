Functions of the Grid: Displaying and Hiding Elements
=====================================================
...
| You should navigate to the page that contains the data for which you wish to change the column display using :icon:`bars` in the ribbon.

#. Click :icon:`angle-down` in the top right hand corner of the page
