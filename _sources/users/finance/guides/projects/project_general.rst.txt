...
#. Click **Finance**
#. Click **Projects**
#. Click the :icon:`ellipsis-h` and click `Edit Project </users/general/guides/functions_of_the_grid/how_to_edit.html>`_project, `Merge Project </users/finance/guides/how_to_merge.html>`_, or **Disable Project** to perform the associated action
