...
#. Click the number under **Enrollments** to view all contacts `enrolled </users/automation/guides/workflows/enroll_contact.html>`_ in the workflow
#. Click the number under **Active** to view all contacts that are currently in the process of completing the workflow
#. Click the number under **Converted** to view all contacts who reached a `Set Goal </users/automation/guides/workflows/set_goal_block.html>`_
