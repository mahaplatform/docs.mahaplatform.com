Phone: Using the Contacts Feature
=================================

| **Contacts** displays a list of the contacts of your organization.
| From here, you can directly and internally call or message a contact following the steps below.

#. Click :icon:`phone` in the ribbon to pull up **Phone** in a side bar
#. Click **Contacts** in the bottom ribbon
#. Click the dropdown menu at the top to switch the phone number
#. Click a name to view the contact
#. Click :icon:`info-circle` to view more `contact information </users/automation/guides/workflows/design_a_workflow.html>`_ associated with the phone number
