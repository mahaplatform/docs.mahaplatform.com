...
#. Click the <i class="fa fa-angle-down"></i> **arrow icon** in the top right hand corner of the page
#. Click a blank column name to add it displayed columns

   * A <i class="fa fa-check"></i> **green check** next to the column name will appear, indicating that it is currently displayed
#. Click a column name with a <i class="fa fa-check"></i> **green check** to hide the column
