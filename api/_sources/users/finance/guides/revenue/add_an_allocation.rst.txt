...
| When filling out certain forms to add check requests, reimbursements, etc., you will be offered the option to add an allocation. You should do this when the overhead cost needs to be divided and attributed to smaller fees.
