...
#. Click **Expenses**
#. Click **Items**
#. Select item(s) by clicking :icon:`circle-thin` to the left of the row

   * You can mass select all the items by clicking :icon:`circle-thin` in the upper left hand corner
#. Click **Submit X item(s)**
